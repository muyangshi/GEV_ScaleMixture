...
Purpose
-------
Produce summary plots describing the timing of JJA (June/July/August) seasonal
block maxima across stations and years. The script counts the number of distinct
calendar days on which station-specific maxima occur, both overall and within
upper-tail percentile subsets.

Outputs
-------
- Fig_unique_peak_dates_hist.pdf
- Fig_unique_peak_dates_by_year_percentiles.pdf
- Fig_unique_peak_dates_combined.pdf
"""
# %%
import pandas as pd
import numpy as np
