...
Before running any analysis, ensure all dependencies listed in the **Preparation** section (below) are installed. In particular, the numerical integration routines must be compiled into a shared library.
