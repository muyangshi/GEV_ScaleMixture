...
Stationary version (Huser Wadsworth)
Fit the real dataset using full marginal model
...
if __name__ == "__main__":
    ...
    radius            = 100                    # radius of Wendland Basis for R
    ...
    bandwidth_rho     = 100                    # range for the gaussian basis for rho
