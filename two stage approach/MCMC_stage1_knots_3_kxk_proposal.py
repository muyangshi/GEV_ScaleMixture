...
#         Sigma_0 = {}
#         Sigma_0['mu'] = 1e-4 * np.identity(k)
#         Sigma_0['tau'] = 1e-4 * np.identity(k)
#         Sigma_0['ksi'] = 1e-4 * np.identity(k)
...
#                 num_accepted['tau'] = 0
#                 Sigma_0_hat = np.cov(np.array([
#                     GEV_knots_trace_stage1[iter-25:iter, 1, i].ravel() for i in range(0, k)
#                 ]))
...
#                 num_accepted['ksi'] = 0
#                 Sigma_0_hat = np.cov(np.array([
#                     GEV_knots_trace_stage1[iter-25:iter, 2, i].ravel() for i in range(0, k)
#                 ]))
