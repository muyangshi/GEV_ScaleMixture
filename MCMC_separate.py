...
if rank == 0:
    # print('R_trace_log')
    # print(R_trace_log)
    np.save('R_trace_log_sep', R_trace_log)
    np.save('phi_knots_trace_sep', phi_knots_trace)
    np.save('range_knots_trace_sep', range_knots_trace)
    np.save('GEV_knots_trace_sep', GEV_knots_trace)