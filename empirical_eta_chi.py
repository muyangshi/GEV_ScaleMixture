...
line_LB = ax.hlines(y=chi_LB, label=r'$\chi$ limit', xmin=0.9, xmax=1.0, 
          colors='tab:red', linewidth=4, clip_on=False)
...
ax.legend([line_est, line_LB],[r'Empirical $\chi$', r'$\chi$ limit'],
          loc = 'upper left', fontsize = 14, handlelength = 3.0)
