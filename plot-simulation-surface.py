...
Purpose
-------
Plot the ground-truth spatial parameter surfaces used in the simulation study:
phi(s) for simulation scenarios 1-3 and the common rho(s) (range) surface used to
construct the Gaussian field Z.

Outputs
-------
- Surface_phi_simcase_<1|2|3>.pdf
- Surface_rho_simulation.pdf
- Surface_all_simulation_surfaces.pdf
"""
