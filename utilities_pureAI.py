...
def qZ(p):
    ...
    return scipy.stats.norm.ppf(p, loc=0, scale=1)
...
def impute_ZY_1t(miss_index, obs_index, Z_vec, mu_vec, sigma_vec, ksi_vec, K):
    ...
    if len(miss_index) == 0: return (None, None)
        ...
        # make conditional gaussian draw
        ...
        Y_miss = qgev(pZ(Z_miss), mu_vec[miss_index], sigma_vec[miss_index], ksi_vec[miss_index])
